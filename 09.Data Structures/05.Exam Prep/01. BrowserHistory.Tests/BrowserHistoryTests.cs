    ...
    public class BrowserHistoryTests
    {
        ...
        public void ViewHistoryWorksCorrectlyWithLink()
        {
            ...
            string expectedResult =
                $"-- https://www.youtube.com/watch?sdgdfds 70s{Environment.NewLine}" +
                $"-- https://www.youtube.com/watch?sdgdfdt 60s{Environment.NewLine}" +
                $"-- https://www.youtube.com/watch?sdgdfdh 50s{Environment.NewLine}";
