...
namespace _03.MinHeap.Tests
{
    ...
    {
        [Test]
        public void Add_SingleElement_TestSize()
        {
        ...
        [Test]
        public void Add_MultipleElements_TestSize()
        {
            var heap = new MinHeap<int>();
        ...
        [Test]
        public void ExtractMin_SingleElement_TestSize()
        {
            var heap = new MinHeap<int>();
        ...
        [Test]
        public void ExtractMin_MultipleElements_TestSize()
        {
            var heap = new MinHeap<int>();
